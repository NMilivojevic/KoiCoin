...
const Expenses: React.FC<ExpensesProps> = ({ onLogout }) => {
    ...
    return (
        <div className="min-h-screen bg-gradient-koi">
            ...
            <main className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                {/* Header */}
                <div className="mb-8">
                    <h1 className="text-3xl font-bold text-koi-text">💸 Expenses</h1>
                    <p className="mt-2 text-koi-muted">
                        Watch your spending koi swim away
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    {/* Today's Expenses */}
                    <div className="bg-koi-dark overflow-hidden shadow-lg rounded-xl p-6 border border-koi-border hover:border-koi-orange transition-colors">
                        <div className="flex items-center">
                                ...
                                {transactions.map((transaction) => (
                                    ...
                                    >
                                        <div className="flex items-center space-x-3">
                                            <div className="w-10 h-10 rounded-full flex items-center justify-center bg-koi-orange/20 border border-koi-orange">
                                        ...
                                        <div className="flex items-center space-x-2">
                                            <div className="text-right">
                                                <p className="text-sm font-semibold text-koi-orange">
                                                    -
